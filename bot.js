...
client.on('message', message => {	
    if (message.content === prefix +'verify') {	
        message.channel.sendMessage('Welcome to our USA! You are now verified.')
    }	
    });	
///////////////////////
client.on('message', message => {
...
client.on('message', message => {
    if (message.content.startsWith(prefix + "start")) {
        message.channel.sendMessage("Thanks for joining our USA. Run ;support for help and have fun!");				
    }
    });
    ////////////
    client.on('message', message => {
    if (message.content.startsWith(prefix + "cmds")) {
        message.channel.sendMessage("Avaliable commands: ;verify, ;ping, ;start, ;cmds, ;support, ;stats, ;botinfo (More soon!)");				
    }
    });
    ////////////
client.on('message', message => {
    ...
    if (message.content.startsWith("donate")) {
        message.channel.sendMessage("To donate, buy the donation product in the #store channel!");
}
...
client.on('message', message => {
    if (message.content.startsWith(prefix + "welcome")) {
	    let kickChannel = message.guild.channels.find(`name`, "announcements").send("We thank you for being in [USA] :| United States of America. Run ;start to begin! :joy:");
